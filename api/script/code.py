# ============================================================
#  qr_generator.py  –  Core QR generation engine
#  Import this from main.py – do not edit for customisation.
# ============================================================
...
def _icon_base64(path, target_width):
    ...
    if path.lower().endswith(".svg"):
        png = cairosvg.svg2png(url=path, output_width=target_width * 2, output_height=target_width * 2)
...
def generate_custom_qr(
    ...
    All colour params accept friendly names ("red", "teal", "gold") or hex ("#e63946").
    Eye shapes accept short names ("cloud", "zig") or a direct file path.
    Icons accept short names ("youtube") or a direct file path.
    """
    ...
    if ext == ".svg":
        ...
        cairosvg.svg2png(bytestring=full_svg.encode(), write_to=output_path)
